...
def _hero_editor_mock() -> str:
    ...
    resume_panel = (
        ...
        f'<div style="font-size:22px;font-weight:800;color:{C_INK};letter-spacing:.16em;">李　默</div>'
        f'<div style="color:{C_INK_MUTE};font-size:11.5px;margin-top:4px;">'
        f'138-0000-0000  |  demo@example.com</div>'
        ...
        f'font-size:12px;font-weight:800;box-shadow:0 4px 12px rgba(59,91,254,.28);">LM</div>'
        f'</div>'
...
def _kanban_sidebar_mock() -> str:
    ...
    return (
        ...
        f'background:{C_PRIMARY};color:#fff;align-items:center;justify-content:center;'
        f'font-size:12px;font-weight:800;">L</span>'
        f'<span style="min-width:0;display:flex;flex-direction:column;">'
        f'<span style="font-size:12.5px;font-weight:700;color:{C_INK};">李默</span>'
